package com.it.institution_project.mapapi
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var lat_location: String = intent.getStringExtra("notic_lat")
        var long_location: String = intent.getStringExtra("notic_long")
